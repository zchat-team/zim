...
type LoginRsp struct {
	...
	ConflictDeviceId     string   `protobuf:"bytes,3,opt,name=conflict_device_id,json=conflictDeviceId,proto3" json:"conflict_device_id,omitempty"`
	ConflictDeviceName   string   `protobuf:"bytes,4,opt,name=conflict_device_name,json=conflictDeviceName,proto3" json:"conflict_device_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_4d297a1638202de6 = []byte{
	...
	,
}
...
func (m *LoginRsp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Message) > 0 {
		...
		i = encodeVarintSess(dAtA, i, uint64(len(m.Message)))
		i--
		dAtA[i] = 0x12
	}
	if m.Code != 0 {
		i = encodeVarintSess(dAtA, i, uint64(m.Code))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
